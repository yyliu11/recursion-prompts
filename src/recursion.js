...
var arraySum = function(array) {
  ...
  if (Array.isArray(lastEle)) {
    sum = arraySum(lastEle) + arraySum(arr)} else {
      sum = lastEle + arraySum(arr)}
  return sum;
};
...
var reverse = function(string) {
  ...
  return string[stringLength - 1] + reverse(string.slice(0, stringLength - 1))
};
...
var palindrome = function(string) {
  ...
  var stringLength = string.length;
  if (stringLength === 1 || stringLength === 0) {return true;}
  if (string[0] !== string[stringLength - 1]) {return false;}
...
var countValuesInObj = function(obj, value) {
  ...
  for (var i = 0; i < arrOfValues.length; i++) {
    ...
    if (typeof arrOfValues[i] === 'object') {
      sum2 += countValuesInObj(arrOfValues[i], value)}
  } return sum1 + sum2;
};
...
var replaceKeysInObj = function(obj, oldKey, newKey) {
    for (var key in obj) {
      if (key === oldKey) { obj[newKey] = obj[key];delete obj[key]
      }
